...
s_Hepatocyte <- read.delim("../data/DM/s_Hepatocyte.txt", stringsAsFactors = F, sep = "\t")
...
curationDrug <- readRDS("../data/DM/curationDrug.rds")
...
doselevel_mapping <- readRDS("../data/DM/doselevel_mapping.rds")
